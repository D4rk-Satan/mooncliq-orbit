  ...
  return (
    <div className="auth-split-layout">
      ...
      <div className="auth-left-panel">
        ...
        <h1 className="auth-tagline">Engineered<br />For Security.</h1>
        <p className="auth-description">
          Securely recover your account and get back to managing your textile workflows with MoonCliq CRM.
        </p>
      </div>
