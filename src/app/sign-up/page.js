  ...
  return (
    <div className="auth-split-layout">
      ...
      <div className="auth-left-panel">
        ...
        <h1 className="auth-tagline">Join the Future<br />of Textiles.</h1>
        <p className="auth-description">
          Create your account today and experience a CRM built specifically to handle the unique supply chain and operational challenges of the modern textile enterprise.
        </p>
      </div>
