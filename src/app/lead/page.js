          ...
          >
            ...
            <div className="kanban-cards">
              {col.leads.map(lead => (
                <div
                  key={lead.id}
                  className="kanban-card minimal-card"
                  onClick={() => setSelectedLead(lead)}
                  style={{ cursor: 'pointer' }}
                >
                  <div className="minimal-card-header">
                    <h4 className="minimal-company">{lead.firstName} {lead.lastName}</h4>
                  </div>
                  ...
                  <div className="minimal-info-row text-muted" style={{ marginTop: '0.25rem' }}>
                    {new Date(lead.createdAt).toLocaleDateString()}
                  </div>

                  {lead.customData?.companyName && (
                    <div className="minimal-info-row text-muted">
                      {lead.customData.companyName}
                    </div>
                  )}
                  {lead.customData?.industry && (
                    <div className="minimal-info-row text-muted">
                      {lead.customData.industry}
                    </div>
                  )}
